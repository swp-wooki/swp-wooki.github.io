...
The absolute value of $$R$$, $$\vert R\vert $$, denote the volume of rectangle $$R$$. Obviously, we know how to compute the volume of rectangle, which is just the product of these numbers: $$(b_1 - a_1)$$ which is the length of this interval up to $$(b_d - a_d)$$. This is the volume of $$R$$. Clearly, for rectangles, each interval can be different.
...
$$
\vert R\vert  = (b_1 - a_1) \times \dots \times (b_d - a_d).
$$
...
$$
\vert R\vert  = \sum_{i=1}^N \vert R_i\vert .
$$
...
$$
\vert R\vert  \le \sum_{i=1}^N \vert R_i\vert .
$$
...
<li markdown="1">**$$\bigcup_{x \in O} I_x$$ is a union of disjoint intervals.** <br>
...
<li markdown="1">**$$\bigcup_{x \in O} I_x$$ contains at most countable intervals.** <br>
...
$$
\vert \mathcal{O}\vert  := \sum_{j=1}^\infty \vert I_j\vert .
$$
