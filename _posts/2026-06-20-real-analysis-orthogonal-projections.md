...
<li markdown="1">If $|H| < \infty$, then any subspace is closed.
</li>
<li markdown="1">If $|H| = \infty$, this is not true in general: $\mathbb{R} \le L^2$ is not closed.
...
Let $S \le H$<span class="real-analysis-footnote">Note: We will denote subspace $S$ of $H$ by $S \le H$.</span> be closed and $f \in H$.

<ol>

<li markdown="1">There exsits $g_0 \in S$ uniquely such that $||f - g_0|| = \inf_{g \in S} ||f - g||$
</li>
...
<li markdown="1">Let $d = \inf_{g \in S} ||f - g||$. Since $f \notin S$ and $S$ is closed, $d > 0$. Then we can choose a sequence $\{g_n\}$ such that 
    ...
    \begin{align*}
        ||g_n - g_m||^2 
        &= 2(||f - g_n||^2 + ||f - g_m||^2) - ||2f - g_n - g_m||^2 \
        &\le 2(||f - g_n||^2 + ||f - g_m||^2) - (2d)^2 \tag{$\ast$}
    \end{align*}
    ...
    \]
    Hence, $||f - \tilde{g}_0||^2 = ||f - g_0||^2 + ||g_0 - \tilde{g}_0||^2$.
</li>
<li markdown="1">Let $g \in S$ and $\epsilon \in \mathbb{R}$. Since $g_0 - \epsilon g \in S$, we have
    <span class="real-analysis-footnote">Note: Following inequality comes from the following calculation:
    \begin{align*}
        ||f - g_0 + \epsilon g||^2
        ...
        &= ||f - g_0||^2 + ||\epsilon g||^2 + \langle f - g_0, \epsilon g \rangle + \langle \epsilon g, f - g_0 \rangle,
    \end{align*}    
        and since 
        \begin{align*}
    ...
    \end{align*}</span>
\begin{align*}
||f - g_0||^2 &\le ||f - (g_0 - \epsilon g)||^2 \
&= ||f - g_0||^2 + \epsilon^2 ||g||^2 + 2\epsilon \text{Re}(f - g_0, g) \tag{$\ast$}
\end{align*}
...
<li markdown="1">if $\text{Re} \langle f - g_0, g \rangle > 0$, then we can take sufficiently small $\epsilon > 0$ such that 
    $$\epsilon^2 ||g||^2 \le 2\epsilon \text{Re} \langle f - g_0, g \rangle,$$ which is a contradiction.
</li>
<li markdown="1">if $\text{Re} \langle f - g_0, g \rangle < 0$, again, take small $\epsilon < 0$ so that 
    $$\epsilon^2 ||g||^2 \le 2\epsilon \text{Re} \langle f - g_0, g \rangle.$$ 
