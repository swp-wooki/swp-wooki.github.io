...
If $$f_k \in \mathcal{F}$$, $$0 \le f_{k} \nearrow f \in L^{1}$$ then $$f\in\mathcal{F}$$. <br>
...
(a) If $$E=Q_{1}\times Q_{2}$$, where $$Q_{i}\subset \mathbb{R}^{d_{i}}$$ are open cubes. <br>
Then $$\chi_{E}^{y}\in L^{1}(\mathbb{R}^{d_{1}})$$ for all $$y$$, and

$$
g(y):=\int_{\mathbb{R}^{d_{1}}}\chi_{E}(x,y)dx = \vert Q_{1}\vert \chi_{Q_{2}}(y) \in L^{1}(\mathbb{R}^{d_{2}})
$$

$$
\int_{\mathbb{R}^{d_{2}}} g(y) dy = \vert Q_{1}\vert \vert Q_{2}\vert  = \int_{\mathbb{R}^{d}}\chi_{E}
$$

Thus, $$\chi_{E}\in\mathcal{F}$$.

 (b) If $$E\subset \partial Q$$ for some $$Q\subset \mathbb{R}^{d}$$ then $$m(E)=0$$. <br>
...
Since $$\chi_{E_{k}}\in\mathcal{F}$$, we have $$\chi_{E}\in\mathcal{F}$$ by Step 2.
 ...
 (e) Finally, if $$E$$ is $$G_{\delta}$$ \& $$m(E)<\infty$$, then $$E=\bigcap_{k=1}^{\infty}\tilde{O}_{k}$$ for some open sets $$\tilde{O}_{k}$$. <br>
...
Note that $$\exists G_{\delta}$$ set $$G\supset E$$ with $$m(G)=0$$. <br>
...
Note that $$\exists G_{\delta}$$ set $$G\supset E$$ s.t. $$m(G\setminus E)=0$$. <br>
Then, $$\chi_{E}=\chi_{G}-\chi_{G\setminus E}\in\mathcal{F}$$.
</li>
<li markdown="1">**Step 6:** If $$f\in L^{1}$$, then $$f\in\mathcal{F}$$. <br>
